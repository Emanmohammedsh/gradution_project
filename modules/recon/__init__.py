...
from modules.recon.service_discovery import ServiceDiscovery
from modules.recon.os_detection    import OsDetection
from modules.recon.asset_inventory import AssetInventory
