...
class OWASPEngine:
    ...
    def register_all(self) -> None:
        from modules.web_security.injection_checker                 import InjectionChecker
        from modules.web_security.broken_access_control_checker     import BrokenAccessControlChecker
        from modules.web_security.auth_failure_checker              import AuthFailureChecker
        from modules.web_security.security_misconfiguration_checker import SecurityMisconfigurationChecker
        from modules.web_security.vulnerable_components_checker     import VulnerableComponentsChecker
        from modules.web_security.cryptographic_failure_checker     import CryptographicFailureChecker
        from modules.web_security.ssrf_checker                      import SSRFChecker
